...
plugins {
    kotlin("multiplatform") version "2.1.20-RC1"
    kotlin("plugin.serialization") version "2.1.20-RC1"
    id("application")
    id("com.adarshr.test-logger") version "4.0.0"
    id("com.google.devtools.ksp") version "2.1.20-RC1-1.0.29"
}
